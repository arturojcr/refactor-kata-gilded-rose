...
public class GildedRose {
  ...
  public static List<GildedItem> items = new ArrayList<>();
...
/*
    ...
    items.add(new BackstagePass(new Item("Backstage passes to a TAFKAL80ETC concert", 15, 20)));
    items.add(new ConjuredItem(new Item("Conjured Mana Cake", 3, 6)));
